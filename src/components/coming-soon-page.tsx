  ...
  return (
    <section className="py-4 sm:py-8">
      <div className="max-w-3xl">
        <span className="inline-flex rounded-full border border-[var(--ink)] bg-[var(--surface-muted)] px-3 py-1 text-xs font-semibold">即将开放</span>
        <h1 className="type-title heading-font mt-5">{title}</h1>
