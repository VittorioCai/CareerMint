...
输出要求：
- 所有解释和方向使用简体中文；资料引用只填写输入中真实存在的 jdSegmentId、resumeSegmentId 和 profileFactIds。
...
- 非 matched 的要求必须填写 gapType 和 problemZh。门槛项 improvement 为 null，因为真实资格不能靠改措辞解决；其余非 matched 要求必须填写 improvement。
...
{"missionZh":"中文岗位使命","coreCapabilities":["能力一","能力二","能力三"],"overallSummaryZh":"中文总体差异判断","requirements":[{"jdSegmentId":"jd-1","kind":"core","comparisonMode":"semantic","conceptLabelZh":"中文概念","jdTerms":["JD 片段中的连续原词"],"importanceReasonZh":"中文重要性理由","priority":"critical","translationZh":"该 JD 片段的中文翻译","assessment":"partial","resumeSegmentId":"resume-2","profileFactIds":[],"gapType":"missing_context","resumeStatusZh":"当前简历已有内容的中文说明","problemZh":"尚未对上的具体问题","reasonZh":"中文判断依据","improvement":{"targetSection":"experience","targetExperienceZh":"应核对的真实经历","focusAreas":["context","stakeholders"],"synonymousJobLanguage":["岗位常用表达"],"needsConfirmation":false,"directionZh":"应核对和补足哪些真实要素，不写可直接粘贴的句子。"}}]}
