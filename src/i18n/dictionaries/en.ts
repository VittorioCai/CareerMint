...
export const en = {
  ...
  difference: {
    control: {
      ...
      fallbacks: {
        conceptLabel: "A requirement of the job",
        importanceReason: "Stated in the job description.",
        translation: "This JD segment came back without a restatement. Run the analysis again.",
        reason: "Judged from the current material.",
        mission: "This run did not reach a judgement about the job's core task. Run the analysis again.",
        overallSummary: "This run did not reach an overall judgement. Run the analysis again.",
        problem: "The resume does not yet cover this requirement in full.",
        direction:
          "Check first whether you have real experience of this. If you do, add the action, situation and result you can point at; if you do not, leave it out of the resume.",
      },
    markdown: {
      // Punctuation is part of the language. A Chinese document takes the
      // full-width colon and semicolon; an English one takes ASCII plus a
      // space, and neither reads right in the other.
      labelSeparator: ": ",
      listSeparator: "; ",
      titleSuffix: "difference analysis",
      exportedAt: "Exported",
      comparisonResume: "Comparison resume",
      resultState: "Result state",
      stale: "This result may be out of date; run the analysis again after the material changes.",
      fresh: "Based on the material selected at export time.",
      jobCoreHeading: "The job's core judgement",
      overallHeading: "Overall difference",
      allDifferencesHeading: "Every difference",
      gatesHeading: "Hard requirements",
      directionsHeading: "Where to improve",
      matchedHeading: "Already matched",
      noIssues: "No ordinary differences were identified.",
      noGates: "No hard requirement needs separate confirmation.",
      noDirections: "There is no publishable guidance.",
      noMatched: "There is no published matched content.",
      jdOriginal: "From the job description",
      explanation: "Restated",
      resumeStatus: "In the resume now",
      resumeQuote: "Quoted from the resume",
      problem: "The problem",
      reason: "How that was judged",
      priority: "Priority",
      authenticity: "Authenticity",
      profileEvidence: "Backed by these facts",
      correspondingDifference: "The difference it answers",
      targetLocation: "Where it goes",
      focus: "What to work on",
      jobTerms: "The job's own words / equivalents",
      directionNote: "The direction",
      unsupportedWarning: "Reminder: if you have not actually done it, leave it out of the resume.",
    },
    issueTypes: {
      missing: "Not covered",
    ...
    profileOnlyStatus:
      "Your career profile has a confirmed fact for this, but nothing in the selected resume says it.",
